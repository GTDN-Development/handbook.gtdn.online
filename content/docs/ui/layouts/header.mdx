---
title: "Header"
description: "A responsive header component with navigation, mobile menu support, and floating bar functionality."
---
...
The Header component is typically used in layout components. Here's an example from a layout:
...
Before installing the Header component, make sure you have completed the [Basic Layout Setup](/docs/ui/layouts/basic-layout) to configure the required navigation files and dependencies.
