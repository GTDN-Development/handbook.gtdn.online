---
title: "Mobile Menu"
description: "A mobile-friendly drawer menu component built on top of Vaul for navigation on smaller screens."
---
...
<Steps>
    ...
    <Step>
        **Create the component file**
        ...
        ```bash
        touch src/components/layout/mobile-menu.tsx
        ```
    </Step>
    <Step>
        **Copy & Paste the code**

        ```tsx title="src/components/layout/mobile-menu.tsx"
      "use client";
