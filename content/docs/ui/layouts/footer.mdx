---
title: "Footer"
description: "A comprehensive footer component with navigation, legal links, social media icons, and theme switcher."
highlight: true
---
...
The Footer component is typically used in layout components. Here's an example from a layout:
...
Before installing the Footer component, make sure you have completed the [Basic Layout Setup](/docs/ui/layouts/basic-layout) to configure the required navigation files and dependencies.
...
<Steps>
    ...
    <Step>
        **Install UI components**
        ...
        Install the required UI components from this library:
        - [Container](/docs/ui/components/container) - Content width constraints
        - [Theme Toggle](/docs/ui/components/theme-toggle) - Theme switcher
    </Step>
    <Step>
